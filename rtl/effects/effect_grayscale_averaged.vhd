...
architecture RTL of effect_grayscale_averaged is
    ...
    begin
        ...
        --To get this effect, we first compute the average-gray and then assign the result to all channels.
        o_pixel(23 downto 16) <= r_gray;
        o_pixel(15 downto 8)  <= r_gray;
        o_pixel(7 downto 0)   <= r_gray;
