...
architecture RTL of img_processing_top is
    ...
    begin
        ...
        r_Red   <= w_rom_video when w_DE = '1' else (others=>'0');;
        r_Green <= w_rom_video when w_DE = '1' else (others=>'0');;
        r_Blue  <=  w_rom_video when w_DE = '1' else (others=>'0');
        o_hdmi_video <= r_Red & r_Green & r_Blue;
		o_hdmi_De <= w_DE;
		o_hdmi_clk <= w_clk25;
